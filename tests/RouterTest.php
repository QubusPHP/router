...
class RouterTest extends TestCase
{
    ...
    public function matchWorksWithaClassAndMethodString()
    {
        ...
        $route    = $router->get('/test/123', 'Qubus\Router\Test\Controllers\TestController@returnHelloWorld');
        $response = $router->match($request);
    ...
    public function matchThrowsExceptionWhenClassAndStringMethodContainsAnUnfoundClass()
    {
        ...
        $route = $router->get('/test/123', 'Qubus\Router\Test\Controllers\UndefinedController@returnHelloWorld');
    }
    ...
    public function matchThrowsExceptionWhenClassAndStringMethodContainsAnUnfoundMethod()
    {
        ...
        $route = $router->get('/test/123', 'Qubus\Router\Test\Controllers\TestController@undefinedMethod');
    }
